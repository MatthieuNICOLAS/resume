...
\position{
  \medskip
  Docteur-Ingénieur en Informatique {\enskip\cdotp\enskip\enskip} Spécialité Ingénierie Logicielle
}
%\address{}
...
%-------------------------------------------------------------------------------
\vspace{-1em}
\input{content/carriere.tex}
\pagebreak

\input{content/education.tex}
\input{content/competences.tex}
\input{content/enseignement.tex}
\input{content/encadrement.tex}
% \input{content/interets.tex}
